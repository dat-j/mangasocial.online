      ...
      <main>
        <div className="p-4 overflow-y-scroll w-full about_p">
          ...
          <p class="text-3xl leading-7 ">
            ...
            on our FutureLove mobile app, and our related online and offline
            offerings. To make this Privacy Notice easier to read, our
            FutureLove mobile app and our related offerings are collectively
            called “Services.”
            <br />
            <br />
            ...
            <br />
            We may revise this Privacy Notice from time to time in our sole and
            absolute discretion. If there are any material changes to this
            Privacy Notice, we will notify you as may be required by applicable
            law effective as of the date of such material changes becoming
            effective. You understand and agree that you will be deemed to have
            accepted the updated Privacy Notice if you continue to use our
            Services after the new Privacy Notice takes effect.
            <br />
            <br />
            <h3 className="text-5xl font-semibold ">
              <a id="3">3. PERSONAL INFORMATION WE COLLECT</a>
            </h3>
            <br />
            ...
            <ol>
              <li>
                (a) Biometric Data. Subject to your separate opt-in consent, we
                may collect biometric data from you including photos and videos
                of your face, including your facial geometry. You may opt out of
                our use of this data at any time by contacting us at the contact
                information provided below in Section 15.
              </li>

              <li>
                (b) Interactive Features. We and others who use our Services may
                collect personal information that you submit or make available
                through our interactive features (e.g., the content that you
                share and social media pages). Any information you provide on
                the public sections of these features will be considered
                “public,” unless otherwise required by applicable law, and is
                not subject to the privacy protections referenced herein.
              </li>

              <li>
                (c) Purchases. As soon as FutureLove allows any purchases, we
                may collect personal information and details associated with
                your purchases, including payment information. In some cases,
                you may need to provide us with additional information to verify
                your identity before completing a transaction. Any payments made
                via our Services are processed by third-party payment
                processors. We do not directly collect or store any payment card
                information entered through our Services, but we may receive
                information associated with your payment card information (e.g.,
                your billing details).
              </li>

              <li>
                (d) Your Communications with Us. We may collect personal
                information, such as email address and phone number when you
                request information about our Services, register to receive our
                newsletter or marketing, request customer or technical support,
                or otherwise communicate with us.
              </li>

              <li>
                (e) Surveys. We may contact you to participate in the surveys.
                If you decide to participate, you may be asked to provide
                certain information which may include personal information.
              </li>

              <li>
                (f) Sweepstakes or Contests. We may collect personal information
                you provide for any sweepstakes or contests that we offer. In
                some jurisdictions, we are required to publicly share
            ...
            <ul>
              <li>
                (a) Automatic Data Collection. We may collect certain
                ...
                address), Internet service provider, and metadata about the
                content you provide which can provide details such as the
              ...
              <li>
                (b) Cookies, Pixel Tags/Web Beacons, and Other Technologies. We,
                as well as third parties that provide content, advertising, or
                other functionality on our Services, may use cookies, pixel
                tags, local storage, and other technologies (“Technologies”) to
                automatically collect information through your use of our
                Services.
              </li>
              <li>
                i. Cookies. Cookies are small text files placed in device
                browsers that store preferences and facilitate and enhance your
                experience.
              </li>
              <li>
                ii. Pixel Tags/Web Beacons. A pixel tag (also known as a web
            ...
            Our use of these Technologies fall into the following general
            categories:
            <br />
            <ul>
              <li>
                ...
                required to identify irregular website behavior, prevent
              ...
              <li>
                ...
                our Services or keeping track of your specified preferences,
            ...
            <br />
            Please see Section 6 below to understand your choices regarding
            these Technologies.
            <br />
            (c) Analytics. We may use Technologies and other third-party tools
            to process analytics information on our Services. Some of our
            analytics partners include Google Firebase. For more information,
            please visit the Google Privacy Terms web page. To learn more about
            how to opt-out of Google’ use of your information on our mobile app,
            ...
            that third-party or third-party application that you have made
            ...
            <ol>
              <li>
                ...
                <ol type="a">
                  <li>
                    Providing face(-s) animation on a photo or a picture
                    features, and other similar Services;
                  </li>
            ...
            <ol>
              <li>
                ...
                <p>
                  ...
                  time as set forth in Section 15 below.
                </p>
              </li>
              <li>
                ...
                <ol type="a">
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      For example, we may allow you to provide information about
                      your friends or colleagues through our referral services.
                      Our referral services may allow you to forward or share
                      certain content with a friend or colleague, such as an
                      email inviting your friend to use our Services.
                    </p>
                  </li>
                </ol>
              </li>
              ...
              <li>
                ...
                <ol type="a">
                  <li>
                    ...
                    <p>
                      When you use the Services, you may choose to share
                      personal information or content with other users or third
                      parties. In addition, certain aspects of your profile may
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      partners to provide you with a product or service you have
                      requested. We may also share your personal information
                      with business partners with whom we jointly offer products
                      or services.
                    </p>
                  </li>
                  <li>
                    ...
                    <p>
                      We may share your personal information, except for your
                      biometric data, with third-party advertising partners.
                      These third-party advertising partners may set
                      Technologies and other tracking tools on our Services to
                      collect information regarding your activities and your
                      device (e.g., your IP address, cookie identifiers, page(s)
                      ...
                      properties within their networks. This practice is
                  ...
                  <li>
                    ...
                    <p>
                      ...
                      the functionality of our Services. For more information
                      about our use of APIs and SDKs, please contact us as set
                      forth below.
                    </p>
                  </li>
                </ol>
              ...
              <ol type="a">
                <li>
                  ...
                  <p>
                    ...
                    communications (e.g., communications regarding our Services
                    or updates to our Terms of Use or this Privacy Notice).
                  </p>
                </li>
                <li>
                  <strong>(b) Text Messages.</strong>
                  <p>
                    You may opt out of receiving text messages from us by
                    following the instructions in the text message you have
                ...
                <li>
                  ...
                  <p>
                    We may send you push notifications through our mobile app.
                    You may opt out from receiving these push notifications by
                    changing the settings on your mobile device. With your
                    consent, we may also collect precise location-based
                    information via our mobile app. You may opt out of this
                ...
                <li>
                  ...
                  <p>
                    ...
                    instructions for Android, iOS and others. The online
                    advertising industry also provides websites from which you
                    may opt out of receiving targeted ads from data partners and
                    other advertising partners that participate in
                    self-regulatory programs. You can access these and learn
                    more about targeted advertising and consumer choice and
                    privacy by visiting the Network Advertising Initiative, the
                    Digital Advertising Alliance, the European Digital
                    Advertising Alliance, and the Digital Advertising Alliance
                    of Canada. Please note you must separately opt out in each
            ...
            <ol type="a">
              <li>
                <strong>(a) Request access to your personal data:</strong>{" "}
                ...
                to verify that we are lawfully processing it.
              </li>
              <li>
                <strong>
                  (b) Request correction of the personal data that we hold about
                  you:
                </strong>{" "}
              ...
              <li>
                <strong>(c) Request erasure of your personal data:</strong> This
              ...
              <li>
                <strong>(d) Object to processing of your personal data:</strong>{" "}
                This applies when we are relying on a legitimate interest (or
                those of a third party) and there is something about your
                particular situation that makes you want to object to processing
                on this ground, as you feel it impacts on your fundamental
                rights and freedoms. You also have the right to object where we
              ...
              <li>
                ...
                <li>
                  ii. Where our use of the data is unlawful but you do not want
                  us to erase it;
                </li>
                <li>
                  iii. Where you need us to hold the data even if we no longer
                  require it as you need it to establish, exercise, or defend
                  legal claims; or
                </li>
                <li>
                  iv. You have objected to our use of your data but we need to
                  verify whether we have overriding legitimate grounds to use
                  it.
                </li>
              </li>
              <li>
                <strong>(f) Request the transfer of your personal data:</strong>{" "}
                We will provide your personal data in a structured, commonly
                used, machine-readable format to you or a third party you have
                chosen. Please note that this right only applies to automated
              ...
              <li>
                <strong>(g) Withdraw consent:</strong> You may withdraw consent
                at any time where we are relying on consent to process your
                personal data. However, this will not affect the lawfulness of
            ...
            <p>
              ...
              unauthorized disclosure. By using our Services or providing
              personal information to us, you agree that we may communicate with
            ...
            <p>
              ...
              data outside the UK. We may transfer your personal data to our
              group companies that are located outside the UK, including, but
              not limited, in the United States, or other countries, which may
              have data protection laws that are different from the laws where
              you live. Whenever we transfer your personal data out of the UK,
              ...
              <li>
                (a) We will only transfer your personal data to countries that
              ...
              <li>
                ...
                protection it has in the UK. Please contact us if you want
            ...
            <p>
              ...
              agreements, and comply with applicable laws. Notwithstanding the
              foregoing, we may store biometric data for three (3) years.
            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            ...
            <p>
              Verification. When you make a request, we will ask you to provide
              ...
              authorized representative, which may include confirming the email
              address associated with any personal information we have about
              you.
            </p>
            <p>
              ...
              Section 15 below. We will process such requests in accordance with
              applicable laws.
            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            ...
            <p>
              ...
              your account. Please note that we do not currently sell your
            ...
            <p>
              ...
              The full list of authorities on the protection of personal data in
              each Vietnam member state.
            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            ...
            <br />
            <p>
              ⇒ Our application takes a photo of a face without makeup, without
              glasses, without a mask. Our application will take a photo of a
              man and 1 photo of a woman to create a pairing event. Take a look
              at our running results here:
              <a
                style={{ color: "blue" }}
                href="https://futurelove.online/detail/920980354218/1"
              >
                https://futurelove.online/detail/920980354218/1{" "}
              </a>
            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            ...
            <p>
              ...
              temporary server. It will serve to generate modal and swap faces,
              we do not store images data for a long time. These face images
              will be deleted immediately after users download or close the
              application.
            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            ...
            <p>
              ...
              want to do that via any other application like social media. This
              information is stored in the user's device. We will only
            ...
            <p>
              ...
              logic is to allow users to store a web link list of events created
              by AI so that users can share online, share love between people. 2
              people, to share with friends who are interested, it may be saved
              for 3-4 month as the user's right, if the user deletes the
              account, it will be lost, the data will disappear if the user
              deletes the account
            </p>
            <br />
            <h3 className="text-5xl font-semibold ">
            ...
            <p>
              ...
              or this Privacy Notice, or to exercise your rights as detailed in
              this Privacy Notice, please contact us at:
              <li>Thinkdiff AI Company</li>
              <li>30Louis7 Louis City Dai Mo, Nam Tu Liem Ha Noi Vietnam</li>
            </p>
          </p>
        </div>
      </main>
